 ...
 * provider id to its brand mark — Google's multicolor "G" today; a future
 * provider (Outlook) just adds a case here and its logo drops into the same slot
 * with no tile rework. An inline SVG, NOT an emoji (emojis render inconsistently
 * across devices and there is no Google-specific one). Unknown → a neutral dot.
 */
